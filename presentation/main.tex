...
\begin{tikzpicture}
  ...
  \node[idea] (diff) at (4,0) {full diffusion};
  \node[idea] (rev) at (8,0) {non-negative revenue};
  \node[idea] (rob) at (12,0) {Sybil robustness};
...
\begin{tikzpicture}[scale=0.80]
  ...
  \node[smallbuyer] (n4) at (0.5,2.45) {4};
  ...
  \node[font=\tiny] at (-1.62,1.90) {A};
  \node[font=\tiny] at (-0.42,1.83) {B};
  \node[font=\tiny] at (0.78,1.83) {C};
  \node[font=\tiny] at (-0.92,0.84) {D};
  \node[font=\tiny] at (0.58,0.81) {E};
  \node[font=\tiny] at (-1.00,-0.14) {F};
  \node[font=\tiny] at (0.35,-0.14) {G};
  \node[font=\tiny] at (2.54,2.18) {H};
  \node[font=\tiny] at (2.76,1.04) {I};
  \node[font=\tiny] at (0.70,2.56) {J};
  \node[font=\tiny] at (1.48,-0.14) {K};
  \node[font=\tiny] at (2.30,0.13) {L};

  \node[below=2.5mm of n8, font=\scriptsize] {(a) social network};

  % -------- (b) diffusion network --------
  \node[seller] (sR) at (6.0,3.0) {$s$};
  ...
  \node[font=\tiny] at (4.46,2.17) {A};
  \node[font=\tiny] at (5.77,2.18) {B};
  \node[font=\tiny] at (7.16,2.18) {C};
  \node[font=\tiny] at (4.61,1.20) {D};
  \node[font=\tiny] at (6.24,1.19) {E};
  \node[font=\tiny] at (4.48,0.35) {F};
  \node[font=\tiny] at (5.56,0.35) {G};
  \node[font=\tiny] at (6.47,0.36) {H};
  \node[font=\tiny] at (7.96,0.36) {I};
  \node[font=\tiny] at (8.72,0.66) {J};
  \node[font=\tiny] at (5.58,-0.56) {K};
  \node[font=\tiny] at (7.96,-0.56) {L};

  \node[below=2.5mm of d8, font=\scriptsize] {(b) diffusion network};
\end{tikzpicture}
\end{frame}
