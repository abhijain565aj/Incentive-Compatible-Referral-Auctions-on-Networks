...
def test_summary_contains_budget_balance_rate():
    rows = [
        {"mechanism": "m", "topology": "line", "n": 10, "valuation_mode": "uniform", "diffusion_strategy": "full", "revenue": 1.0, "welfare": 1.2, "n_participants": 10},
        {"mechanism": "m", "topology": "line", "n": 10, "valuation_mode": "uniform", "diffusion_strategy": "full", "revenue": -0.1, "welfare": 0.9, "n_participants": 10},
    ]
    out = summarize(rows)
    assert len(out) == 1
